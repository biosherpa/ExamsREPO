...
########### BLOQUE PARA INCRUSTAR DESPUÉS DE PREGUNTAS G1/G2/G3 ########G#
  ...
  snippet cal
	...
	**Comentarios:** -
	...
	```
  Uso: Escribe cal + Mayús + Tab debajo de cada respuesta del alumno e insertará el texto (que luego puedes modificar) y un chunk para insertar el vector de calificación.
